        ...
        <div class="content__items">
          <div class="cart__item">
            ...
            <div class="cart__item-info">
              <h3>Декаф Флэт Уайт</h3>
              <p>300 мл с молоком</p>
            </div>
          ...
          <div class="cart__item">
            <div class="cart__item-img">
              <img class="pizza-block__image" src={ProductFifth} alt="Coffee" />
            </div>
            <div class="cart__item-info">
              <h3>Декаф Флэт Уайт</h3>
              <p>300 мл без молока</p>
            </div>
            <div class="cart__item-count">
              <div class="button button--outline button--circle cart__item-count-minus">
                <svg
          ...
          <div class="cart__item">
            <div class="cart__item-img">
              <img class="pizza-block__image" src={ProductSixth} alt="Coffee" />
            </div>
            <div class="cart__item-info">
              <h3>Декаф Флэт Уайт</h3>
              <p>300 мл с молоком</p>
